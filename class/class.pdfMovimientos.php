...
class pdfMovimientos extends FPDF
{
    ...
    public function Titulo()
    {
        ...
        //Título
        $this->Cell(0, 10, iconv('UTF-8', 'ISO-8859-1', 'Informe: Listado de Movimientos'), 0, 1, 'C', true);
    ...
    public function Cabecera()
    {
        ...
        $this->Cell(50, 7, iconv('UTF-8', 'ISO-8859-1', 'Cuenta'), 'B', 0, 'C', true);
        $this->Cell(40, 7, iconv('UTF-8', 'ISO-8859-1', 'Fecha Hora'), 'B', 0, 'C', true);
        $this->Cell(30, 7, iconv('UTF-8', 'ISO-8859-1', 'Concepto'), 'B', 0, 'C', true);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Tipo'), 'B', 0, 'C', true);
        $this->Cell(20, 7, iconv('UTF-8', 'ISO-8859-1', 'Cantidad'), 'B', 0, 'R', true);
    ...
    function Contenido($movimientos)
    {
        ...
        foreach ($movimientos as $movimiento) {
            ...
            $this->Cell(10, 7, mb_convert_encoding($movimiento->id, 'ISO-8859-1', 'UTF-8'), 0, 0, 'R');
            $this->Cell(50, 7, mb_convert_encoding($movimiento->cuenta, 'ISO-8859-1', 'UTF-8'), 0, 0, 'C');
            $this->Cell(40, 7, mb_convert_encoding($movimiento->fecha_hora, 'ISO-8859-1', 'UTF-8'), 0, 0, 'C');
            $this->Cell(30, 7, mb_convert_encoding($movimiento->concepto, 'ISO-8859-1', 'UTF-8'), 0, 0, 'C');
            $this->Cell(20, 7, mb_convert_encoding($movimiento->tipo, 'ISO-8859-1', 'UTF-8'), 0, 0, 'C');
            $this->Cell(20, 7, mb_convert_encoding($movimiento->cantidad, 'ISO-8859-1', 'UTF-8'), 0, 0, 'R');
            $this->Cell(20, 7, mb_convert_encoding($movimiento->saldo, 'ISO-8859-1', 'UTF-8'), 0, 1, 'R');
        }
    }
}
